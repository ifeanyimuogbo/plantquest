...
const RequirementBar = ({icon, barPercentage}: any) => {
  return (
...
const RequirementDetail = ({icon, label, details}) => {
  return (
  ...
  function renderRequirements() {
    return (
      <View
        ...
        <RequirementDetail icon={icons.sun} label="Sunlight" details="15°C" />
        <RequirementDetail
          icon={icons.drop}
          label="Water"
          details="250 ML Daily"
        />
        <RequirementDetail
          ...
          details="25°C"
        />
        <RequirementDetail icon={icons.garden} label="Soil" details="3 kg" />
        <RequirementDetail
          icon={icons.seed}
          label="Fertilizer"
          details="150 Mg"
